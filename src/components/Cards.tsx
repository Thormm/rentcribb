...
type CardProps<T extends { border: string; tier: number; rating: number; reviews: number; title: string; location: string; price: string }> = {
  item: T;
};

export default function Card<T extends { border: string; tier: number; rating: number; reviews: number; title: string; location: string; price: string }>({
  item,
}: CardProps<T>) {
  return (
    <div
