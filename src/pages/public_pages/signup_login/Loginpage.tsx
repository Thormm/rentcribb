...
export default function Loginpage() {
  ...
  const toggleMode = () => {
    ...
    if (currentDomain.includes("student.cribb.africa")) {
      targetDomain = "https://www.business.cribb.africa";
    } else if (currentDomain.includes("business.cribb.africa")) {
      targetDomain = "https://www.student.cribb.africa";
    } else {
  ...
  const getDashboardUrl = () => {
    if (mode === "student") {
      ...
      return "https://www.business.cribb.africa/businessdash";
    }
  };
  ...
  const getRentSpaceUrl = () => {
    return "https://www.student.cribb.africa/studentlisting";
  };
          ...
          <div className="relative mx-2 md:mx-auto my-10 md:w-[500px] bg-[#F4F6F5] border-3 rounded-4xl border-black p-6">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex justify-center mt-1">
                  <span className="inline-block text-xs p-2 rounded-2xl text-black bg-white">
                    New or Returning? Have a room or looking for one? Find
                    roommate faster, cheaper and softer on Cribb.
                  </span>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex justify-center mt-1">
                  <span className="inline-block text-xs p-2 rounded-2xl text-black bg-white">
                    Browse listings,and connect directly with hosts. Post
                    request, review offers and accept your taste.
                  </span>
                </div>
              </div>
