...
const ReferralCard: React.FC<ReferralCardProps> = ({
  ...
  // referral url
  const referralURL = `https://www.cribb.africa?ref=${encodeURIComponent(code || "")}`;
    ...
    try {
      ...
      if (
        ...
        (navigator as any).canShare?.({
          files: [new File([blob], "qrcode.png")],
        })
      ) {
        const file = new File([blob], "cribb-referral.png", {
          type: "image/png",
        });
        // @ts-ignore
  ...
  const handleCopyCode = async () => {
    try {
      ...
      console.error(err);
      setErrorMsg("Unable to copy code");
    }
  };
        ...
        <div className="hidden md:flex items-center text-black w-full">
          ...
          <div className="flex flex-col items-center -ml-3 relative z-20">
            ...
            <div
              ...
              role="button"
              tabIndex={0}
              onKeyPress={(e) => e.key === "Enter" && handleCopyCode()}
          ...
          >
            ...
            <div className="flex justify-center my-7">
              ...
              >
                <QRCode
                  value={referralURL}
                  size={window.innerWidth < 480 ? 170 : 230}
                />
              </div>
            </div>
