...
interface LandlordDetails {
  landlord_callno: string;
  landlord_email: string;
  landlord_whats: string;
  bname_landlord: string;
  babout_landlord: string;
  baddress_landlord: string;
  kin: string;
  address: string;
  call_no: string;
  first: string;
  ...
  useEffect(() => {
    const fetchLandlordDetails = async () => {
      ...
      try {
        ...
        if (data.success && data.landlord_details) {
          setLandlordDetails(data.landlord_details);
        } else {
      ...
      TIER1: {
        ...
        features1: [
          ...
          [
            ...
            landlordDetails.landlord_callno ? "Good" : "Pending",
          ],
          [
            "Business Address",
            landlordDetails.baddress_landlord ? "Good" : "Pending",
          ],
          [
            "Business Description",
            landlordDetails.babout_landlord ? "Good" : "Pending",
          ],
        ],
        features2: [
    ...
    <div className="bg-white md:py-10 mb-20">
      <section className="px-3 md:px-10 flex justify-center">
        <div className="w-full">
          {/* Header */}
          <SectionHeader title={landlordDetails.first || "user"} />
